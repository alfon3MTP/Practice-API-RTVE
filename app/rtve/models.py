...
class Genre(Base):
    ...
    programs = relationship("Program", secondary=program_genre, back_populates="generos")
...
class Program(Base):
    ...
    generos = relationship("Genre", secondary=program_genre, back_populates="programs")
